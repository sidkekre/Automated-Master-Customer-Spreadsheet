...
class DocuSignConnectHandler:
    ...
    def __init__(self, envelope_db: Any = None) -> None:
        self._integration_key = os.getenv('DOCUSIGN_INTEGRATION_KEY')
        self._user_id = os.getenv('DOCUSIGN_USER_ID')
        auth_url = os.getenv('DOCUSIGN_AUTH_URL', 'https://account.docusign.com')
        self._oauth_host = self._parse_oauth_host(auth_url)
        self._private_key = os.getenv('DOCUSIGN_PRIVATE_KEY')
        self._consent_redirect_uri = os.getenv('DOCUSIGN_CONSENT_REDIRECT_URI')
